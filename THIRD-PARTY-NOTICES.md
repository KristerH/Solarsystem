...
This project bundles the Open Sans font (`Resources/Fonts/OpenSans-Regular.ttf`,
`OpenSans-Semibold.ttf`), licensed under the Apache License, Version 2.0. The
full license text follows, as required by that license.

Data sources are credited in the [README](README.md#credits) rather than
here, since none of them ship as files in this repository — the app's own
code encodes the values it needs from them.
